...
public class Livro{
    ...
    public double calcularPrecoPorPagina(){
        double precoPorPagina = getQtdPaginas() / getPreco();
        return precoPorPagina;
    }

    public String precoPorPaginaFormatado(){
        String precoPorPaginaFormatado = String.format("%.2f", calcularPrecoPorPagina());
        return precoPorPaginaFormatado;
    }
